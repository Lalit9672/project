...
const cpaper = () => {
  return (
    ...
    <div className="main-block">
      ...
      <p>
        <strong>
          <span>Proposal Invited for Special Forums</span>
        </strong>
      </p>
      <br />
      <p>
      ...
      <br />
      <p>
        Each Special Forum proposal should include: (1) a cover note that
        briefly explains the significance of the special focus and introduces
        the prospective guest editors (2) a draft of the call for papers for the
        Special Forum (450-word limit).
      </p>
      <br />
      <p>
      ...
      <p>
        <strong>
          <span>Copyright and Acknowledgement as the Original Publisher</span>
        </strong>
      </p>
      <br />
      <p>
